...
namespace Scheduler.BusinessLayer
{
	...
	public class Common
	{
		...
		public static string GetShortVersionInfo()
		{
			try
			{
                ...
                string strVersion = "Version " + assemblyname.Version.Major.ToString() + "." +
                    ...
                    assemblyname.Version.Revision.ToString() + " -- VS12 / DX12.2.7";
		...
		{
            GridView view = grd.DefaultView as GridView;
            //view.Appearance.Preview.Font = new System.Drawing.Font(Common.FontName, Common.FontSize, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
            if(view != null)
