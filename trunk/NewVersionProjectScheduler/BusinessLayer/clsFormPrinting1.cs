...
namespace Scheduler.BusinessLayer
{
	...
	public class FormPrinting1
	{
		...
		public PageSettings ps = null; // choose print orientation (Automatic, Protrait or Landscape)
		...
		public delegate void  ControlPrinting1(DevExpress.XtraGrid.GridControl c,
			ParentControlPrinting typePrint, 
			MultiPageManagement mp, 
			Single x, Single y,
			ref Single extendedHeight, out bool ScanForChildControls);
		...
		//Constructor
		public FormPrinting1(System.Windows.Forms.Control f)
		{
			_f = f;
			...
			//AddDelegateToPrintControl("DevExpress.XtraGrid.GridControl", new ControlPrinting1(PrintGridView));
		}
