...
namespace Scheduler
{
	...
	public class frmContactBrw : System.Windows.Forms.Form
	{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmContactBrw));
			...
			// gvwContact
			// 
			this.gvwContact.BehaviorOptions = ((DevExpress.XtraGrid.Views.Grid.BehaviorOptionsFlags)((((((((((DevExpress.XtraGrid.Views.Grid.BehaviorOptionsFlags.AllowFilter | DevExpress.XtraGrid.Views.Grid.BehaviorOptionsFlags.AllowZoomDetail) 
				| DevExpress.XtraGrid.Views.Grid.BehaviorOptionsFlags.EnableDetailToolTip) 
			...
			this.gvwContact.DefaultEdit = this.repositoryItemTextEdit1;
			this.gvwContact.FocusRectStyle = DevExpress.XtraGrid.Views.Grid.DrawFocusRectStyle.RowFocus;
			this.gvwContact.Name = "gvwContact";
			this.gvwContact.PrintOptions = ((DevExpress.XtraGrid.Views.Grid.PrintOptionsFlags)((((((((DevExpress.XtraGrid.Views.Grid.PrintOptionsFlags.AutoWidth | DevExpress.XtraGrid.Views.Grid.PrintOptionsFlags.ExpandAllGroups) 
			...
			this.gvwContact.ViewOptions = ((DevExpress.XtraGrid.Views.Grid.ViewOptionsFlags)((((DevExpress.XtraGrid.Views.Grid.ViewOptionsFlags.AutoWidth | DevExpress.XtraGrid.Views.Grid.ViewOptionsFlags.ShowColumns) 
			...
			this.gcolContactType.SortOrder = DevExpress.Data.ColumnSortOrder.Ascending;
		...
		public void LoadContact(string option)
		{
            ...
            else if (option == "Instructor")
            {
                ...
                gcolLastNameRomaji.VisibleIndex = 2;
                gcolFirstNameRomaji.VisibleIndex = 3;
                gcolJobTitle.VisibleIndex = 4;
                gcolPhone.VisibleIndex = 5;
                gcolStatus.VisibleIndex = 6;
                gcolCompany.VisibleIndex = 7;
